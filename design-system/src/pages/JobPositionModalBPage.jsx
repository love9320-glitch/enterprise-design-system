// 채용 분야 설정 모달 B — test 하위 메뉴(2026-07-24 지시).
// URL(#job-position-modal-b)로 직접 진입하면 모달이 바로 열린 상태로 시작한다.
...
export function JobPositionModalBPage() {
  ...
  return (
    <section className="mx-auto max-w-5xl px-spacing-7 py-spacing-10 text-left">
      <h2 className="mb-spacing-3 text-20 font-semibold text-font-icon-5">채용 분야 설정 모달 B</h2>
      <p className="mb-spacing-8 text-14 text-font-icon-4">
        Job Position Template B타입 모달 단독 테스트 페이지 — URL로 직접 진입하면 모달이 바로 열립니다.
        액션 버튼 4종(리셋·코드 등록·엑셀)은 모달 푸터 왼쪽에 나타납니다.
      </p>
