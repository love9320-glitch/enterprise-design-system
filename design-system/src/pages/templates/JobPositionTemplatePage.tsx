...
const USAGE = `import { JobPositionTemplate } from '@gusun/design-system';
...
const ref = useRef<any>(null); // 저장 API — ref.current.validate() / getRows()
...
<JobPositionTemplate
  ...
  onExcelUpload={(file: any) => parse(file)}       // 대량 등록 팝오버에서 파일 선택 시(.xlsx/.xls 1개)
