...
import { ScreeningBuilderTemplate } from '@gusun/design-system';
import { Button } from '@gusun/design-system';
import { UsageExample } from '../../components/UsageExample';
import { Divider } from '@gusun/design-system';

const USAGE = `import { ScreeningBuilderTemplate } from '@gusun/design-system';
...
const OPT = (...labels: string[]) => labels.map((l: any, i: any) => ({ value: `v${i}`, label: l }));
const YN_TABS = [
  { value: 'target', label: '대상' },
  ...
  return (
    <section className="py-spacing-10 text-left">
      ...
      <div>
        ...
        <ScreeningBuilderTemplate key={resetKey} ref={builderRef} defaultCards={DEMO_CARDS as any} cardMenu={CARD_MENU as any} />
        {saved && (
