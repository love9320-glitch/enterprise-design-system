import { fontSize, lineHeight } from '@gusun/design-system/tokens';
...
const lhOf = (size: any) => (fontSize as any)[size]?.[1]?.lineHeight;
          ...
          {leadings.map((key: any) => (
            <div key={`lh-${key}`} className="rounded-round-4 border border-base-gray-100 p-spacing-6">
              <p className="mb-spacing-4 font-mono text-12 text-font-icon-3">
                leading-{key} · {(lineHeight as any)[key]}
              </p>
