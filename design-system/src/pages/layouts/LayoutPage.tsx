...
import { AppLayout } from '@gusun/design-system';
import { Page } from '@gusun/design-system';
import { Lnb } from '@gusun/design-system';
import { Gnb, GnbGroup, GnbLogo } from '@gusun/design-system';
import { RightPanel } from '@gusun/design-system';
import { Button } from '@gusun/design-system';
import { ButtonGroup } from '@gusun/design-system';
import { Avatar } from '@gusun/design-system';
...
const USAGE = `import { AppLayout } from '@gusun/design-system';
import { Lnb } from '@gusun/design-system';
import { Gnb, GnbGroup, GnbLogo } from '@gusun/design-system';
import { RightPanel } from '@gusun/design-system';
import { Button } from '@gusun/design-system';
...
function DemoMainContent({ panelUsed, panelOpen, onTogglePanel, stickyHeader }: any) {
...
function DemoRightPanel({ onClose }: any) {
    ...
    <section className="py-spacing-10 text-left">
      ...
      <div className="mb-spacing-6 flex flex-wrap items-center gap-x-spacing-8 gap-y-spacing-5">
        <div className="flex items-center gap-spacing-6">
          ...
          <Select width="hug" options={LNB_WIDTH_OPTIONS} value={lnbWidth} onChange={(e: any) => setLnbWidth(e.target.value)} disabled={!showLnb} />
        </div>
        <div className="flex items-center gap-spacing-4">
          <p className="text-12 text-font-icon-3">Right Panel</p>
          <Checkbox label="사용" checked={panelUsed} onChange={() => setPanelUsed((v) => !v)} />
          <Select width="hug" options={PANEL_MODE_OPTIONS} value={panelState} onChange={(e: any) => setPanelState(e.target.value)} disabled={!panelUsed} />
          <Select width="hug" options={PANEL_WIDTH_OPTIONS} value={panelWidth} onChange={(e: any) => setPanelWidth(e.target.value)} disabled={!panelUsed} />
        </div>
        <div className="flex items-center gap-spacing-4">
          <p className="text-12 text-font-icon-3">Page</p>
          <Select width="hug" options={PAGE_WIDTH_OPTIONS} value={pageWidth} onChange={(e: any) => setPageWidth(e.target.value)} />
          <Select width="hug" options={PAGE_PADDING_OPTIONS} value={pagePadding} onChange={(e: any) => setPagePadding(e.target.value)} />
