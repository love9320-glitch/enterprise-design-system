...
import { SegmentControlButton, SegmentControlGroup } from '@gusun/design-system';
import { UsageExample } from '../../components/UsageExample';
import { Divider } from '@gusun/design-system';

const USAGE = `import { SegmentControlGroup } from '@gusun/design-system';
...
<SegmentControlGroup value={view} onChange={(v: any) => setView(v)} items={...} />
  ...
  return (
    <section className="py-spacing-10 text-left">
      ...
      <div>
        ...
        <SegmentControlGroup value={view} onChange={(v: any) => setView(v)} items={VIEW_ITEMS} />
      </div>
