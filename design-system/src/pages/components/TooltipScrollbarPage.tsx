import { Tooltip } from '@gusun/design-system';
import { ScrollArea } from '@gusun/design-system';
import { Divider } from '@gusun/design-system';
import { UsageExample } from '../../components/UsageExample';

const TOOLTIP_USAGE = `import { Tooltip } from '@gusun/design-system';
...
const SCROLL_USAGE = `import { ScrollArea } from '@gusun/design-system';
...
const DIVIDER_USAGE = `import { Divider } from '@gusun/design-system';
    ...
    <section className="py-spacing-10 text-left">
      ...
      <div>
        ...
        <div className="space-y-spacing-7">
          {['subtle', 'default', 'strong'].map((c: any) => (
