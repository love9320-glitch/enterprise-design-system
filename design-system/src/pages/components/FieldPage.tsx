...
const USAGE = `import { Field } from '@gusun/design-system';
import { Input } from '@gusun/design-system';
...
const CONTACT_USAGE = `import { EmailField, PhoneField } from '@gusun/design-system';
...
<EmailField
  ...
  value={email}
  onChange={(e: any) => setEmail(e.target.value)}          // e.target.source: 'select'|'input'|null
  width="100%"
/>
...
function ContactLiveDemo({ Comp, options }: any) {
