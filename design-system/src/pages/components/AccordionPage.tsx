...
import { Accordion, AccordionItem } from '@gusun/design-system';
import { Button } from '@gusun/design-system';
import { UsageExample } from '../../components/UsageExample';
import { Divider } from '@gusun/design-system';

const USAGE = `import { Accordion, AccordionItem } from '@gusun/design-system';
...
export function AccordionPage() {
  ...
  const rename = (id: any, title: any) =>
    setItems((prev: any) => prev.map((it: any) => (it.id === id ? { ...it, title } : it)));
  const remove = (id: any) => setItems((prev: any) => prev.filter((it: any) => it.id !== id));
  const add = () =>
    setItems((prev: any) => [
      ...prev,
