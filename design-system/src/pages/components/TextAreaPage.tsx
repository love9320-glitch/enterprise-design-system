...
const USAGE = `import { TextArea } from '@gusun/design-system';

// 제어 컴포넌트 + 글자수 카운터(maxLength 분모)
const [memo, setMemo] = useState('');
<TextArea value={memo} onChange={(e: any) => setMemo(e.target.value)} maxLength={100} />
...
function Playground() {
  ...
  const toggle = (k: any) => (e: any) => setOpts((o) => ({ ...o, [k]: e.target.checked }));
  const num = (setter: any) => (e: any) => setter(Math.max(1, Number(e.target.value) || 1));
