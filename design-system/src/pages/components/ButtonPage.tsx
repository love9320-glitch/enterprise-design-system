...
const GROUP_USAGE = `import { ButtonGroup } from '@gusun/design-system';
import { Button } from '@gusun/design-system';
...
const POPOVER_USAGE = `import { Popover } from '@gusun/design-system';
import { PopoverMenu } from '@gusun/design-system';
import { ListGroup } from '@gusun/design-system';
import { List } from '@gusun/design-system';
...
const USAGE = `import { Button } from '@gusun/design-system';
...
function VariantBlock({ variant, label, tinted = false, rows = BUTTON_ROWS }: any) {
  return (
    ...
    <section className="py-spacing-10 text-left">
      ...
      <div>
        ...
        <div className="flex flex-wrap items-center gap-spacing-7">
          {['black', 'red', 'blue', 'green', 'violet', 'pink', 'orange'].map((c: any) => (
      ...
      <div>
        ...
        <div className="flex flex-wrap items-center gap-spacing-5">
          <Button asChild variant="fill">
            <a href="#button" onClick={(e: any) => e.preventDefault()}>fill 링크</a>
          </Button>
          <Button asChild variant="line" leftIcon={ChevronDown}>
            <a href="#button" onClick={(e: any) => e.preventDefault()}>line 링크(아이콘)</a>
          </Button>
          <Button asChild variant="underline" color="blue">
            <a href="#button" onClick={(e: any) => e.preventDefault()}>underline 링크</a>
          </Button>
        </div>
