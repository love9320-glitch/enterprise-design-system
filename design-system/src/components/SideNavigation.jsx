...
export function SideNavigationButton({
  ...
  return (
    <button
      ...
      className={`flex min-h-[32px] w-full items-center px-spacing-6 py-spacing-4 text-left transition-colors ${rounding} ${STATE_STYLE[state]} ${className}`}
      {...props}
    >
...
export function SideNavigation({
  ...
  return (
    <nav
      ...
      className={`flex flex-col gap-spacing-2 ${line ? 'border-r border-side-nav-right-line' : ''} ${className}`}
      {...props}
    >
