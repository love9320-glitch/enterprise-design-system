...
const md = {
  ...
  strong: ({ node, ...p }: any) => <strong className="font-semibold text-font-icon-5" {...p} />,
  em: ({ node, ...p }: any) => <em className="text-font-icon-4" {...p} />,
...
export function MarkdownDoc({ source }: any) {
  // 선두 YAML 프론트매터(---\n...\n---) 제거 — 페이지엔 본문만 렌더한다
