...
import { applyColumnFilters, applySort } from '../components/tableView';
import type { TableRowData, TableSort } from '../components/tableView';
...
export function TableTemplate({
  ...
  // 세로 스택 갭: 컨트롤 행↔테이블↔페이지네이션 12(spacing-6, 2026-08-07 지시 — 07-28의 8을 12로 환원)
  return (
